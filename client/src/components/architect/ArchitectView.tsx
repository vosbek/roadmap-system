  ...
  React.useEffect(() => {
    const fetchApplication = async () => {
      try {
        ...
        const response = await fetch('/api/applications/17', { signal }); // eB2B application ID
        if (!response.ok) {
      ...
      <div className="border-b bg-white shadow-sm">
        <div className="px-6 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Application Architecture</h1>
              <p className="text-sm text-gray-500 mt-1">{application.name} - Detailed architectural view and roadmap</p>
            </div>
