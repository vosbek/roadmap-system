...
import { 
  ArrowLeft, Calendar, AlertCircle, BarChart3,
  ChevronRight, ChevronDown, Filter,
  Rocket, Power, Wrench, Trash2, Zap
} from 'lucide-react';
...
const TeamRoadmapView: React.FC = () => {
  ...
  const getProjectStyle = (project: Project, index: number): CSSProperties => {
    ...
    const verticalPosition = index * (barHeight + verticalGap);
      ...
      <div className="border-b bg-white shadow-sm">
        <div className="px-6 py-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">{team.name} Roadmap</h1>
...
export default TeamRoadmapView; 